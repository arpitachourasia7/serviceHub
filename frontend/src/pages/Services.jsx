...
//             alert('Failed to load services. Please check if backend is running.');
//         } finally {
//             setLoading(false);
//         }
//     };
...
//             if (editingService) {
//                 // UPDATE existing service (using UUID)
//                 const response = await api.patch(`/services/${editingService.id}/`, serviceData);
